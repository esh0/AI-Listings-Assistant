...
export default function ReguaminPage() {
    return (
        ...
        >
            ...
            <p>Wiadomości powyższe mają charakter transakcyjny i serwisowy — są niezbędne do prawidłowej realizacji Usługi lub bezpośrednio z nią związane. Podstawą ich wysyłki jest art. 6 ust. 1 lit. b lub f RODO. Usługobiorca może zrezygnować z powiadomienia o niskim stanie Kredytów, kontaktując się z Administratorem pod adresem: <a href="mailto:privacy@marketplace-ai.pl">privacy@marketplace-ai.pl</a>.</p>
