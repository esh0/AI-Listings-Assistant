...
Paleta kolorów: bg `#FAF9F9`, tekst `#363D45`, akcent `#FB8527`, brand `#6366f1`
Czcionka: Montserrat (Bold dla nagłówków, Regular dla podtytułów)

| # | Temat | Nagłówek | Status |
|---|-------|----------|--------|
...
### Post 1 — powitalny
```
Cześć! Jestem Marketplace AI — narzędzie, które pisze ogłoszenia za Ciebie.

Zdjęcie + kilka kliknięć = gotowe ogłoszenie na OLX, Allegro, Vinted i Facebook Marketplace.

Bez stresu. Bez marnowania czasu. Za darmo.

Link w bio → marketplace-ai.pl

#ogłoszenia #olx #vinted #sprzedajemy #ai
```

### Post 2 — przed/po
```
Pisałeś ogłoszenie 20 minut?

Tytuł, opis, cena, zdjęcia, formatowanie...

AI zrobi to za Ciebie w 30 sekund. Serio.

Wypróbuj za darmo → link w bio

#olx #vinted #sprzedajemy #ai #oszczędnośćczasu
```

### Post 3 — bezpłatny plan
```
5 ogłoszeń miesięcznie całkowicie za darmo.

Żadnej karty kredytowej.
Logujesz się przez Google i zaczynasz od razu.

Sprawdź sam → link w bio

#olx #vinted #allegro #sprzedajemy #ai
```

### Post 4 — 4 platformy
```
OLX, Allegro Lokalnie, Vinted, Facebook Marketplace.

Każda platforma ma inne zasady, inny styl, inne oczekiwania.

Marketplace AI zna je wszystkie i dopasowuje ogłoszenie do każdej z nich.
...
### Post 5 — AI rozpoznaje
```
Wrzuć zdjęcie — AI rozpoznaje, co sprzedajesz.

Marka, stan, kategoria — wszystko analizowane automatycznie.

Ty tylko klikasz "Generuj".

Wypróbuj → link w bio

#ai #sztucznainteligencja #olx #vinted #sprzedajemy
```

### Post 6 — ton ogłoszenia
```
Profesjonalnie na Allegro. Przyjaźnie na Vinted. Swobodnie na OLX.

Każda platforma rządzi się swoimi prawami.

Wybierz styl — AI napisze ogłoszenie dokładnie w tym tonie.

Link w bio → marketplace-ai.pl

#ogłoszenia #olx #vinted #allegro #ai
```

### Post 7 — cena
```
"Ile wziąć za tę kurtkę?"

Nie zgaduj. AI przeanalizuje zdjęcia i zaproponuje realną cenę na podstawie stanu produktu.

Ty decydujesz — AI tylko doradza.
...
### Post 8 — ile rzeczy
```
Masz w domu rzeczy, które czekają na sprzedaż?

Ubrania, elektronika, książki, zabawki...

Zamiast odkładać na później — wygeneruj ogłoszenie w 30 sekund.

Link w bio → marketplace-ai.pl

#sprzedajemy #olx #vinted #secondhand #ai
```

### Post 9 — końcowy CTA
```
Mniej pisania, więcej sprzedawania.

Dołącz do osób, które już nie tracą czasu na pisanie ogłoszeń.

Zacznij za darmo → link w bio

#sprzedajemy #olx #vinted #allegro #ai
```

### Post 10 — social proof
```
Pierwsze 3 rzeczy z garażu — sprzedane.
Oceny: 5.0/5. Wszystkie zweryfikowane przez OLX.

"Przedmiot zgodny z opisem" — bo opis napisało AI, które widziało zdjęcia.

Sprawdź sam → link w bio

#olx #sprzedajemy #ai #ogłoszenia #opinie
```
